    ...
    <div [formGroup]="form" class="flex flex-col items-center gap-4 w-80">
      <div class="w-full flex flex-col items-start">
        ...
        <mat-radio-group formControlName="materiel" class="flex flex-col items-start gap-1 w-full">
          <mat-radio-button *ngFor="let option of materialOptions" [value]="option.value" class="text-left">
            {{ option.label }}
          </mat-radio-button>
        </mat-radio-group>
      ...
      <app-input label="Nombre de participants" [control]="form.get('participants')!" type="number" [required]="true"[min]="2"></app-input>
